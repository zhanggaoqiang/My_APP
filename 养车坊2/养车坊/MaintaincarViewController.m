...
@interface MaintaincarViewController ()

@property(nonatomic,strong)NSMutableArray *dataArr;

@end

@implementation MaintaincarViewController
...
-(void)loadDataPage:(NSInteger)page {
    ...
    NSString *newUrl =[NSString stringWithFormat:CARBAIKE_URL,self.currentPage,3];
