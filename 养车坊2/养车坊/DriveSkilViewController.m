...
@interface DriveSkilViewController ()

@property(nonatomic,strong)NSMutableArray *dataArr;

@end

@implementation DriveSkilViewController
...
-(void)loadDataPage:(NSInteger)page {
    ...
    NSString *newUrl =[NSString stringWithFormat:CARBAIKE_URL,(long)self.currentPage,2];
