...
- (void)viewDidLoad
{
    ...
    REMenuItem *homeItem = [[REMenuItem alloc] initWithTitle:@"新闻"
                                                    subtitle:nil
    ...
    REMenuItem *exploreItem = [[REMenuItem alloc] initWithTitle:@"影评"
                                                       subtitle:nil
    ...
    REMenuItem *activityItem = [[REMenuItem alloc] initWithTitle:@"预告片"
                                                        subtitle:nil
    ...
    REMenuItem *profileItem = [[REMenuItem alloc] initWithTitle:@"排行榜"
